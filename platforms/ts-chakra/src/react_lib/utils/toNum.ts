...
// TODO: It is not really clear in what context a date would be passed in here.
// Further investigation warranted.
export default function toNum(value: number | string /* a date */ | null | undefined): number {
